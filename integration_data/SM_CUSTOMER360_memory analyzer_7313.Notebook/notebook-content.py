...
dataset = "SM_CUSTOMER360" # Enter the name or ID of the semantic model
workspace = "INTEGRATION DATA (D)" # Enter the workspace name or ID in which the semantic model exists
